...
colors.highlightFg = "#" +colors.color[17][7];
colors.sidebar = "#" +colors.color[17][9];
colors.highlight = "#" +colors.color[2][5];
...
document.body.style.setProperty("--highlight-bg-color", colors.highlightBg);
document.body.style.setProperty("--highlight-fg-color", colors.highlightFg);
document.body.style.setProperty("--sidebar-color", colors.sidebar);
document.body.style.setProperty("--highlight-color", colors.highlight);
